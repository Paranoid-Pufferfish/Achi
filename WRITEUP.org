...
** Important Functions:
Obviously we can NOT go over the entire code base, as its more than 2K lines of code. So we will instead highlight the key functions that are reused throughout the project:
